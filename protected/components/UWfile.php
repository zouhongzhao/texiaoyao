...
class UWfile {
	...
	public function init() {
		return array(
			'name'=>__CLASS__,
			'label'=>Yii::t("site",'File field'),
			'fieldType'=>array('VARCHAR'),
			'params'=>$this->params,
			'paramsLabels' => array(
				'path'=>Yii::t("site",'Upload path'),
			),
	...
	public function editAttribute($model,$field,$params=array()) {
		...
		.' '.CHtml::activeLabelEx($model,'[uwfdel]'.$field->varname,array('label'=>Yii::t("site",'Delete file'),'style'=>'display:inline;')):'')
		;
	}
