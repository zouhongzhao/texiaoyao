...
class UWjuiAutoComplete {
	...
	public function init() {
		return array(
			'name'=>__CLASS__,
			'label'=>Yii::t("site",'jQueryUI autocomplete',array(),__CLASS__),
			'fieldType'=>array('INTEGER'),
			'params'=>$this->params,
			'paramsLabels' => array(
				'modelName'=>Yii::t("site",'Model Name',array(),__CLASS__),
				'optionName'=>Yii::t("site",'Lable field name',array(),__CLASS__),
				'emptyFieldLabel'=>Yii::t("site",'Empty item name',array(),__CLASS__),
				'emptyFieldValue'=>Yii::t("site",'Empty item value',array(),__CLASS__),
				'relationName'=>Yii::t("site",'Profile model relation name',array(),__CLASS__),
				'minLength'=>Yii::t("site",'minimal start research length',array(),__CLASS__),
			),
		);
	}
