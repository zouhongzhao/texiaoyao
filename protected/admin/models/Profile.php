...
class Profile extends UActiveRecord
{
	...
	public function relations()
	{
		...
		if (isset(Functions::$profileRelations)) $relations = array_merge($relations,Functions::$profileRelations);
		return $relations;
	}
	...
	public function attributeLabels()
	{
		...
		foreach ($model as $field)
			$labels[$field->varname] = ((Functions::$fieldsMessage)?Yii::t('site',$field->title,array(),Functions::$fieldsMessage):Yii::t('site',$field->title));
