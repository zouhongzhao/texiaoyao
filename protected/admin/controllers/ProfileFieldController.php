...
class ProfileFieldController extends Controller
{
	...
	function showWidgetList(type) {
		...
		$('div.widget select').append('<option value=\"\">".Yii::t("site",'No')."</option>');
		if (wgByType[type]) {
	...
	// show all function 
	$('div.form p.note').append('<br/><a href=\"#\" id=\"showAll\">".Yii::t("site",'Show all')."</a>');
	...
	public function actionAdmin()
	{
		$dataProvider=new CActiveDataProvider('ProfileField', array(
			'pagination'=>array(
				'pageSize'=>Functions::$fields_page_size,
			),
			'sort'=>array(
